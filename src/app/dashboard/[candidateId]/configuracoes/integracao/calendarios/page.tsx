...
import IntegracaoCalendarios from '@/components/configuracoes/IntegracaoCalendarios';

export default function CalendariosPage({ params }: { params: { candidateId: string } }) {
